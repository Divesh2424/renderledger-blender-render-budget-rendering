...
Планировщик измерений времени рендера и требований сцены без обещаний ускорения.
...
- **Render sample journal** — запланированный модуль; реализации нет.
- **Scene resource worksheet** — запланированный модуль; реализации нет.
- **Device comparison notes** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Render sample journal**.
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию Blender, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Scene resource worksheet

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию Blender, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Device comparison notes

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию Blender, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | Blender |
| Категория | Инструменты для программ |
| Входные данные | Ручные записи или разрешенный пользователем локальный экспорт |
| Планируемый результат | Render sample journal |
